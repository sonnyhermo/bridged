		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="txtEmployer" name="employer[]" placeholder="Enter Employer/Business">
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
		...
		<div class="row">
			<div class="col-md-5">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="txtJob" name="job[]" placeholder="Enter Job/Position">
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
					<label for="txtFname">Length Operation <span class="text-danger">*</span></label>
					<input type="text" class="form-control" id="txtLengthEmployed" name="length_employed[]" placeholder="Enter Length Employed">
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
					<label for="txtFname">Monthly Income <span class="text-danger">*</span></label>
					<input type="text" class="form-control" id="txtIncome" name="income[]" placeholder="Enter Monthly Income">
				</div>
			</div>
		</div>
		<div class="row">
